...
class TrainOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--mask_light', default=False, type=bool, help="Whether to mask out the prediction of lighting")
        self.parser.add_argument('--flip_input', action='store_true', help='Whether to augment the input by flipping')
        self.parser.add_argument('--disable_mixing', action='store_true', help='Whether to disable the style mixing')
        ...
        self.parser.add_argument('--hist_lambda', default=0.0, type=float, help='Hist loss multiplier factor')
        self.parser.add_argument('--smooth_lambda', default=0.0, type=float, help='Smooth loss multiplier factor')
        self.parser.add_argument('--sym_lambda', default=0.0, type=float, help='Symmetry loss multiplier factor')
        self.parser.add_argument('--sym_lpips_lambda', default=0.0, type=float, help='Symmetric LPIPS loss multiplier factor')

        self.parser.add_argument('--stylegan_weights', default=model_paths['nerf_face_lighting'], type=str,
