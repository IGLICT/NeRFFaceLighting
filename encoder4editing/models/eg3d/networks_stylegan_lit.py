...
from .triplane import OSGDecoder
...
from .volumetric_rendering.renderer import ImportanceRenderer, sample_from_planes

from .networks_stylegan2 import FullyConnectedLayer, SynthesisBlock, MappingNetwork
...
class TriPlaneGenerator(torch.nn.Module):
    ...
    def forward(self, z, c, z_l, l, input_is_latent=False, truncation_psi=1, truncation_cutoff=None, neural_rendering_resolution=None, update_emas=False, cache_backbone=False, use_cached_backbone=False, **synthesis_kwargs):
